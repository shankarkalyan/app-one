                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            {[
                              { label: 'Sick Leave', color: '#ef4444', icon: '🏥', desc: 'Medical absence' },
                              { label: 'Vacation / PTO', color: '#f59e0b', icon: '🏖️', desc: 'Planned time off' },
                              { label: 'Training Session', color: '#8b5cf6', icon: '📚', desc: 'Skill development' },
                              { label: 'Extended Meeting', color: '#06b6d4', icon: '👥', desc: 'Long meetings' },
                              { label: 'Workload Balancing', color: '#10b981', icon: '⚖️', desc: 'Task redistribution' },
                              { label: 'Personal Emergency', color: '#ec4899', icon: '🚨', desc: 'Urgent matters' },
                              { label: 'Other Reason', color: '#64748b', icon: '📝', desc: 'Miscellaneous' },
                              { label: 'No Reason', color: '#475569', icon: '—', desc: 'Not specified' },
                            ].map((item) => (
                              <div
                                key={item.label}
                                style={{
                          ...
                          <div style={{
                            ...
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                <div style={{ width: '10px', height: '10px', borderRadius: '2px', background: 'linear-gradient(90deg, #22c55e, #16a34a)' }} />
                                <span style={{ color: isDark ? '#94a3b8' : '#64748b' }}>Done</span>
                              </div>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#fbbf24', opacity: 0.5 }} />
                                <span style={{ color: isDark ? '#94a3b8' : '#64748b' }}>Active</span>
                              </div>
                            </div>
                          </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  Specialist moved to unallocated pool (sick leave, vacation, etc.)
                                </div>
                              </div>
                            </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  Individual task moved from one specialist to another
                                </div>
                              </div>
                            </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  Specialist reallocated to a different workflow phase
                                </div>
                              </div>
                            </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  Multi-cert specialist transferred (tasks reassigned or dual-phase assigned)
                                </div>
                              </div>
                            </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  Specialist removed from dual-phase, now in single phase only
                                </div>
                              </div>
                            </div>
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <div style={{
                                  ...
                                  New specialist first assigned to a workflow phase
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <input
                        ...
                        onFocus={(e) => {
                          e.target.style.borderColor = colors.chaseBlue;
                          e.target.style.boxShadow = `0 0 0 3px ${colors.chaseBlue}20`;
                        }}
                        onBlur={(e) => {
                      ...
                      {historySearchQuery && (
                        <button
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.transform = 'translateY(-50%) scale(1.15) rotate(90deg)';
                            e.currentTarget.style.boxShadow = '0 3px 10px rgba(239, 68, 68, 0.5)';
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.transform = 'translateY(-50%) scale(1) rotate(0deg)';
                            e.currentTarget.style.boxShadow = '0 2px 6px rgba(239, 68, 68, 0.35)';
                          }}
                        >
                          <X size={12} />
                        </button>
                    ...
                    <button
                      style={{
                        ...
                        transition: 'all 0.2s ease',
                        boxShadow: '0 2px 4px rgba(24, 95, 165, 0.1)',
                      }}
                      onClick={fetchAllocationHistory}
                      onMouseEnter={(e) => {
                        if (!loadingHistory) {
                          e.currentTarget.style.background = isDark
                            ? 'linear-gradient(135deg, rgba(24, 95, 165, 0.25) 0%, rgba(24, 95, 165, 0.15) 100%)'
                            : 'linear-gradient(135deg, rgba(24, 95, 165, 0.18) 0%, rgba(24, 95, 165, 0.1) 100%)';
                          e.currentTarget.style.borderColor = isDark ? 'rgba(24, 95, 165, 0.6)' : 'rgba(24, 95, 165, 0.4)';
                          e.currentTarget.style.boxShadow = '0 4px 8px rgba(24, 95, 165, 0.2)';
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = isDark
                          ? 'linear-gradient(135deg, rgba(24, 95, 165, 0.15) 0%, rgba(24, 95, 165, 0.08) 100%)'
                          : 'linear-gradient(135deg, rgba(24, 95, 165, 0.1) 0%, rgba(24, 95, 165, 0.05) 100%)';
                        e.currentTarget.style.borderColor = isDark ? 'rgba(24, 95, 165, 0.4)' : 'rgba(24, 95, 165, 0.25)';
                        e.currentTarget.style.boxShadow = '0 2px 4px rgba(24, 95, 165, 0.1)';
                        e.currentTarget.style.transform = 'translateY(0)';
                      }}
                      disabled={loadingHistory}
                    >
                      <RefreshCw size={15} style={loadingHistory ? { animation: 'spin 1s linear infinite' } : {}} />
                      <span style={{ letterSpacing: '0.3px' }}>Refresh</span>
                    </button>
                  </div>
                </div>
                ...
                {loadingHistory ? (
                  ...
                  const filteredHistory = allocationHistory.filter(event => {
                    ...
                    return (
                      ...
                      (event.to_specialist_name || '').toLowerCase().includes(query) ||
                      (event.from_specialist_name || '').toLowerCase().includes(query) ||
                      (event.application_id || '').toLowerCase().includes(query) ||
                      (event.performed_by_name || '').toLowerCase().includes(query)
                    );
                  });
                  ...
                  if (filteredHistory.length === 0) {
                    return (
                      <div style={{
                        ...
                        <div style={{ fontSize: '12px', marginTop: '4px' }}>
                          Try searching by specialist name, reason, or event type
                        </div>
                      </div>
                    );
                  }
                      ...
                      >
                          ...
                          <div style={{
                            ...
                            {event.event_type === 'MOVED_TO_UNALLOCATED' && (
                              <span style={{
                                ...
                                moved to <strong style={{ color: colors.orange }}>Not Allocated</strong>
                              </span>
                            )}
                            {event.event_type === 'TASK_REASSIGNMENT' && (
                              <span style={{
                                ...
                                task reassigned to <strong style={{ color: colors.chaseBlue }}>{event.to_specialist_name || 'Unknown'}</strong>
                              </span>
                            )}
                            {event.event_type === 'REALLOCATION' && (
                              <span style={{
                                fontSize: '12px',
                                color: isDark ? '#94a3b8' : '#64748b',
                              }}>
                                moved from <strong>{event.from_phase?.replace('_', ' ') || 'N/A'}</strong> to <strong style={{ color: colors.success }}>{event.to_phase?.replace('_', ' ') || 'N/A'}</strong>
                              </span>
                            )}
                            {event.event_type === 'PHASE_TRANSFER' && (
                              <span style={{
                                ...
                                {event.reason === 'phase_transfer_dual_assigned' ? (
                                  <>now active in <strong style={{ color: '#185FA5' }}>{event.to_phase?.replace(/\+/g, ' + ')?.replace(/_/g, ' ') || 'multiple phases'}</strong></>
                                ) : (
                                  <>transferred from <strong>{event.from_phase?.replace(/_/g, ' ') || 'N/A'}</strong> to <strong style={{ color: '#185FA5' }}>{event.to_phase?.replace(/_/g, ' ') || 'N/A'}</strong></>
                                )}
                              </span>
                            )}
                            {event.event_type === 'DUAL_PHASE_REMOVED' && (
                              <span style={{
                                ...
                                removed from dual-phase, now only in <strong style={{ color: '#ef4444' }}>{event.to_phase?.replace(/_/g, ' ') || 'single phase'}</strong>
                              </span>
                            )}
                          </div>
                        ...
                        <span style={{
                          ...
                          {event.event_type === 'MOVED_TO_UNALLOCATED' ? 'Out' :
                           ...
                           event.event_type === 'PHASE_TRANSFER' ? (event.reason === 'phase_transfer_dual_assigned' ? 'Dual' : 'Transfer') :
